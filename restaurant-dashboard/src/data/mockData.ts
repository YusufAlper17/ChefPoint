...
export const mockRestaurants: Restaurant[] = [
  {
    ...
    menu: [
      ...
      },
      {
        ...
        category: 'Tatlı',
        price: 95,
        image: 'https://images.unsplash.com/photo-1606312619070-d48b4cac5ccf?w=600&q=80',
        calories: 450,
...
export const mockReviews: Review[] = [
  {
    ...
    images: ['https://images.unsplash.com/photo-1513104890138-7c749659a591?w=400&q=80']
  },
  {
    id: 'review-2',
    userId: 'user-2',
  ...
  },
  {
    ...
    menuItemId: 'menu-10',
    rating: 5,
    comment: 'Salmon nigiri harikaydı, ağzınızda eriyor.',
